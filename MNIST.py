...
traindata = traindata.reshape(traindata.shape[0], 28*28).astype('float64')/255#scale仅支持最多2维的数组，而标签也是一个维度，所以如果28*28变成28,28最终train_x就会变成三维数组导致报错
...
N2 = 26  #  # of windows -------Feature mapping layer
N3 = 680 #  # of enhancement nodes -----Enhance layer
